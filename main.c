...
// --------- Тесты ----------
#include "tests/cyrillicaTest.h" // Проверка ввода. Допустима только кириллица.
#include "tests/helpTest.h" // Проверка запроса помощи от пользователя.
#include "tests//letterTest.h" // Проверка повторного ввода буквы.
// --------- Символьная графика --------
#include "cli/viselica.h" // Символьная графика попыток с отображением виселицы.
#include "cli/hello.h" // Приветствие и правила
#include "cli/end.h" // Сообщение и задержка завершения программы до нажатия клавиши "Enter"
#include "cli/attempts.h" // Вывод оставшихся попыток
